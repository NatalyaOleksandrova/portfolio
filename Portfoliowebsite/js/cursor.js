(function(modules) { // webpackBootstrap
  ...
  if (!isMobileDevice()) {
      ...
      function Cursor(options) {
          ...
          this.el = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div class="ht-cursor"></div>');
          this.text = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div class="ht-cursor-text"></div>');
          this.init();
      }
      ...
      _createClass(Cursor, [{
          ...
          key: "bind",
          value: function bind() {
              // Ваш існуючий код для біндінгу подій
          }
      }, {
